...
#ns 1505041_Wireless_802_11_static.tcl $r
ns wired-cum-wireless-sim.tcl $r
echo "SIMULATION COMPLETE. BUILDING STAT......"
#awk -f rule_th_del_enr_tcp.awk 802_11_grid_tcp_with_energy_random_traffic.tr > math_model1.out
#awk -f 1505041_rule_tcp_wireless.awk 1505041_tcp_wireless.tr > 1505041_tcp_wireless.out
awk -f wireless_awk.awk wired-and-wireless.tr > wireless.out
...
thrput_file="throughputWireless.out"
delay_file="delayWireless.out"
delRatio_file="deliveryRatioWireless.out"
dropRatio_file="dropRatioWireless.out"

echo -ne "$(($r*100)) 	$thr\n" >> $thrput_file
echo "$(($r*100)) 	$del" >> $delay_file
...
echo -ne "$(($r*100)) 	$del_ratio\n" >> $delRatio_file
echo "$(($r*100)) 	$dr_ratio" >> $dropRatio_file
