...
set dist(10m) 2.81838e-5 
set dist(20m) 8.91754e-6 
set dist(30m) 6.0908e-6  
set dist(40m) 1.7615e-6  
set dist(50m) 1.20174e-7 
 
set itrNo [lindex $argv 0]
Phy/WirelessPhy set CSThresh_ $dist([expr $itrNo *10 ]m)
Phy/WirelessPhy set RXThresh_ $dist([expr $itrNo *10 ]m)
