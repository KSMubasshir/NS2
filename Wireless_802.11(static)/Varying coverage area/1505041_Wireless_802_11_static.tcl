...
set itrNo [lindex $argv 0];

set cbr_size 1000
set cbr_rate 11.0Mb
set cbr_interval [expr 0.01 / 2 ];# ?????? 1 for 1 packets per second and 0.1 for 10 packets per second
puts "num of packets/second [expr 1 / $cbr_interval ]"
#set num_row [lindex $argv 0] ;#number of row
#set num_col [lindex $argv 0] ;#number of column

set num_row  5;#[expr $itrNo * 20 ];
set num_col 12;
...
#CHNG
set num_parallel_flow 5 ;#[lindex $argv 0]
set num_cross_flow 5 ;#[lindex $argv 0]
set num_random_flow 0;#[expr $itrNo * 10 ];
puts "num of flows: 10"
...
set nm 1505041_tcp_wireless.nam
set tr 1505041_tcp_wireless.tr
set topo_file 1505041_topo_tcp_wireless.txt
#set topo_file 5.txt
# 
# Initialize ns
#
...
set dist(100m)  6.8808e-9
set dist(200m)  8.9175e-10 
set dist(300m)  1.7615e-10 
set dist(400m)  5.5735e-11 
set dist(500m)  2.2829e-11 

Phy/WirelessPhy set CSThresh_ $dist([expr $itrNo * 100]m)
Phy/WirelessPhy set RXThresh_ $dist([expr $itrNo * 100]m)
puts "Coverage :$itrNo Tx"
