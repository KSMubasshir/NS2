...
set cbr_interval [expr 0.01 / 2 ]; puts "#pkts/s : [expr 1 / $cbr_interval ]"
set num_row 5 ;#number of row
set num_col [expr $itrNo * 4] ; puts "#nodes : [expr $num_row * $num_col ]"
set x_dim 300
set y_dim 300
...
set num_parallel_flow 4
set num_cross_flow 4
