...
set cbr_interval 0.01 ; puts "#pkts/s : [expr 1 / $cbr_interval ]"
set num_row 5 ;#number of row
set num_col 12 ; puts "#nodes : [expr $num_row * $num_col ]"
set x_dim 300
set y_dim 300
...
puts "#flows : [expr $num_parallel_flow+$num_cross_flow]"
